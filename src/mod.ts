import { Vec3, ColorType,Vec2, Geometry, activeDiffGet, Text, ModelScene, GeometryMaterial, AnimatedObjectInput} from "https://deno.land/x/remapper@3.1.2/src/mod.ts"
...
export function getBookmarks(returnType: returnBookmark): bookmarkObject[] {
    ...
    let returnArray: bookmarkObject[] = [];
